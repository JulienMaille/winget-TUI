...
manifest for the agreements). Failures are visible in the streamed log, not
...
The selected rows are shown with a green `[x]`; click a row or press `space`
to toggle it. If a Portable package's files were changed outside winget (e.g.
